...
$imports = @(
    ...
    'google_container_node_pool.prod_pool["sm"] projects/wax100/locations/asia-northeast1-a/clusters/wax100-platform/nodePools/prod-sm',
    'google_container_node_pool.prod_pool["md"] projects/wax100/locations/asia-northeast1-a/clusters/wax100-platform/nodePools/prod-md',
    'google_container_node_pool.prod_pool["lg"] projects/wax100/locations/asia-northeast1-a/clusters/wax100-platform/nodePools/prod-lg',
